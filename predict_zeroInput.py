...
def train():
    ...
    for epoch, content in dataLoad.gen_epochs_predict(args.datapath, args.start_step, n_batch_size, args.delta_step, args.velocity_multiplier):
        ...
        for _x, _x_size, _y, _y_size in epoch:
            ...
            feed_dict = { placeHolder_X: _x, placeHolder_X_size: _x_size, placeHolder_Y: _y, placeHolder_test_input: initial_RNN_input, placeHolder_Y_size: _y_size, placeHolder_max_length: maxl_array }
            rnnOutput = sess.run(test_outputs, feed_dict)
