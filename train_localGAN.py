...
import model_localGAN as model
from model_localGAN import model_particles as model_net
...
ptrapps = tf.summary.scalar('lGAN discriminator Loss', model.d_loss)
ptrapps = tf.summary.scalar('lGAN generator Loss', model.g_loss)
