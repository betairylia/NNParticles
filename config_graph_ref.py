...
config_dict = {
    ...
    '2048_newRegular_512d_kernelConv_AdaIN': {
        'useVector': False,
        'encoder': {
            'blocks' : 3,
            'particles_count' : [2048, 512, 32],
    ...
    '2048_vecRegular_refine_512d_AdaIN': {
        'useVector': True,
        'encoder': {
            'blocks' : 5,
            'particles_count' : [2048, 1280, 512, max(256, ccnt * 2), 64],
            'conv_count' : [1, 2, 2, 0, 0],
            'res_count' : [0, 0, 0, 2, 4],
            'kernel_size' : [k, k, k, k, k],
            'bik' : [0, 16, 16, 16, 64],
        ...
        'decoder': {
            'blocks' : 2,
            'pcnt' : [512, 2048], # particle count
            'generator' : [5, 3], # Generator depth
            'maxLen' : [0.0, 0.5],
            'nConv' : [2, 0],
            'nRes' : [3, 0],
            'hdim' : [max(ld, hd * 2), hd // 3],
    ...
    '2048_vecRegular_doubleDec_512d_AdaIN': {
        'useVector': True,
        'encoder': {
            'blocks' : 5,
            'particles_count' : [2048, 1280, 512, max(256, ccnt * 2), 64],
